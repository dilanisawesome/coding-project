  ...
  return (
    <>
      <p>
        ...
        opportunity to play in a rivalry game against the Ohio State Univeristy.
        You have an exam the next day, and if you play in the game, you won't be
        able to study. What do you do?
      </p>
      <Button
        handleClick={study ? () => {} : () => setPlay(true)}
        text="Play in the game"
      />
      <Button handleClick={() => setStudy(true)} text="Study for your exam" />
      <Text
        text={
          play
